...
module.exports = {
  config: {
    ...
    author: "Rakib + hoon",
    category: "fun",
    guide: "{prefix}bro [@mention/reply]"
  },
...
"ভাইয়ের প্রতি বোনের ভালোবাসা,  
থাকবে চিরদিন অটুট ও দৃঢ়। 💙"`;
      ...
      for (const url of bgUrls) {
        try {
          ...
          console.warn("Failed to load bro background from", url, e);
        }
      }
      ...
      function createPlaceholder(name) {
        const size = 200;
        const img = new Jimp(size, size, "#e0f0ff");
